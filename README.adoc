...
image:https://img.shields.io/badge/maven%20central-v2.10.1-blue.svg["Maven Central",link="https://search.maven.org/#search%7Cga%7C1%7Ca%3A%22quickfixj-spring-boot-starter%22"]
image:https://img.shields.io/hexpm/l/plug.svg["Apache 2",link="http://www.apache.org/licenses/LICENSE-2.0"]
image:https://img.shields.io/badge/quickfixj-2.3.1-blue.svg["QuickFIX/J 3.0.0", link="https://github.com/quickfix-j/quickfixj"]
...
You will also need to add a QuickFix/J compatible implementation of the message classes.
These artefacts are not transitive dependencies of this project to make it is easier to customise a QuickFix/J implementation.
Please see the https://github.com/quickfix-j/quickfixj[QuickFIX/J project] for details of how to customise QuickFix/J for your Rules of Engagement.
